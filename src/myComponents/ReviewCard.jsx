...
const ReviewCard = (props) => {
    return (
        <div className="p-6 w-2/5 max-lg:w-4/5 flex flex-col gap-4 justify-center items-center border-2 border-white rounded-3xl shadow-xl">
            <div className="h-24 w-24 overflow-hidden mb-2 rounded-full flex border-4 border-coral-red justify-center items-center p-1">
            ...
            <p className="text-coral-red font-bold font-montserrat text-center">{props.productName}</p>
        </div>
    )
}
