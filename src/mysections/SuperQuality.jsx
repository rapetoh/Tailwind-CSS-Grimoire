  ...
  return (
    <div className="flex flex-row gap-16 items-center max-lg:flex-col">
      <div className="flex flex-col justify-start items-start w-2/5 max-lg:w-4/5">
        <h1 className="text-4xl max-lg:text-3xl font-bold font-montserrat my-6">We Provide You <span className="text-purple font-bold font-montserrat">Super Quality</span> Shoes</h1>
